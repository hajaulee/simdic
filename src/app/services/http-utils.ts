...
export const PROXY_KEY = "AKfycbyQLSGx69MPJIZmAbenLMbi38dcFEtmp2sVQrVxsmVUEtB6WDOKt9Arz2OX1PkxccBn"
export const PROXY_URL = `https://script.google.com/macros/s/${PROXY_KEY}/exec`;
